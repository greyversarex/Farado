...
const translations = {
  ...
  en: {
    nav: { services: 'Services', programs: 'For Business', about: 'About', process: 'How We Work', blog: 'Blog', contact: 'Contact', clientPortal: 'Client Portal' },
  ...
  tj: {
    nav: { services: 'Хизматрасонӣ', programs: 'Барои тиҷорат', about: 'Дар бораи ширкат', process: 'Тарзи кори мо', blog: 'Блог', contact: 'Тамос', clientPortal: 'Портали мизоҷон' },
  ...
  zh: {
    nav: { services: '服务', programs: '商业服务', about: '关于我们', process: '工作流程', blog: '博客', contact: '联系我们', clientPortal: '客户端口' },
