...
export function EditItemForm({ item, onClose, onUpdate }: EditItemFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Form data totalAmount:', formData.totalAmount);
    console.log('Form data remainingAmount:', formData.remainingAmount);
    console.log('Submit data totalAmount:', submitData.totalAmount);
    console.log('Submit data remainingAmount:', submitData.remainingAmount);
      ...
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <CardHeader className="pb-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
            <CardTitle className="text-lg">Редактировать товар</CardTitle>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="unpaid">Постоплата</SelectItem>
