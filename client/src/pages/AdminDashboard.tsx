        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="bg-gradient-to-r from-white to-gray-50 rounded-xl shadow-lg border border-gray-200 p-2 sm:p-3 mb-8 mobile-nav-tabs">
            <TabsList className="grid w-full grid-cols-4 h-16 sm:h-18 bg-transparent rounded-lg gap-1 sm:gap-2">
              ...
              >
                <Package className="w-4 h-4 sm:w-5 sm:h-5 mb-1 mobile-nav-icon" />
                <span className="text-xs font-medium leading-tight">Заказы</span>
              </TabsTrigger>
              <TabsTrigger 
                value="warehouses" 
                className="relative text-xs sm:text-sm font-semibold px-1 py-2 rounded-lg transition-all duration-300 
              ...
              <TabsTrigger 
                ...
                flex flex-col items-center justify-center mobile-nav-tab"
              >
                <Users className="w-4 h-4 sm:w-5 sm:h-5 mb-1 mobile-nav-icon" />
                <span className="text-xs font-medium leading-tight">Контрагенты</span>
              </TabsTrigger>
              <TabsTrigger 
                value="search" 
                className="relative text-xs sm:text-sm font-semibold px-1 py-2 rounded-lg transition-all duration-300 
                ...
                flex flex-col items-center justify-center mobile-nav-tab"
              >
                <Search className="w-4 h-4 sm:w-5 sm:h-5 mb-1 mobile-nav-icon" />
                <span className="text-xs font-medium leading-tight">Поиск</span>
              </TabsTrigger>
            </TabsList>
          </div>
